...
> 按照作者的操作，访问百度后，响应体中，response里看到的内容，preview没看到，这是为啥呢
 ...
 ###### &nbsp;&nbsp;&nbsp; 讲师回复：
> &nbsp;&nbsp;&nbsp; preview 就是 reponse 的预览，确实有可能在某些情况下 preview 不显示的，因为某些页面是需要执行 js 才能显示出来的，所以 preview 的结果不一定是浏览器你看到的结果。可以以 response 的源代码为准。

##### **6313：
> 感谢老师&nbsp;

##### **0921：
> 之前都是在腾讯课堂，网易云课堂学习，发现拉勾网资源好赞👍，老师好棒

##### *欣：
> 怎么视频打不开啊

 ###### &nbsp;&nbsp;&nbsp; 编辑回复：
> &nbsp;&nbsp;&nbsp; 小编这边查看视频没有问题，您如果还打不开可以关注拉勾公众号咨询小助手
...
##### **编程：
> 2020.11.12年打卡第一天，希望今年结束前能入门

##### **林：
> 开始了开始了。小北要开始学习了！

##### **航：
> <div><span style="font-size: 16.7811px;">容都是经过 SSL 加密的，它的主要作用可以分为两种：</span></div><div><span style="font-size: 16.7811px;"><br></span></div><div><span style="font-size: 16.7811px;">建立一个信息安全通道，来保证数据传输的安全。</span></div><div><span style="font-size: 16.7811px;">确认网站的真实性，凡是使用了 HTTPS 的网站，都可以通过点击浏览器地址栏的锁头标志来查看网站认证之后的真实信息，也可以通过 CA 机构颁发的安全签章来查询。</span></div>

##### *瑞：
> 买了好久了，现在才开始学习，太懒了。。。<div>另外，想问一下，这些课程会不会有时间限制，会不会到哪一天就下架了？</div>
...
##### **轩：
> 打卡 第一天 内容很详细 有些地方理论偏多 可以多点实际操作就完美了

##### **琪：
> 适合有一定基础的来做系统学习，课程很好，但是我觉得不适合真的零基础的。零碎的做了一些实操再来看此课程感觉有种梳理知识点的感觉，很扎实

##### **7257：
> 打卡第一天😀

##### **辉：
> 除了get和post，我还看见过option，请问这是啥？？？<br>

 ###### &nbsp;&nbsp;&nbsp; 讲师回复：
> &nbsp;&nbsp;&nbsp; 这也是 HTTP 的一个请求 method，如：https://www.zhihu.com/question/40292779

##### **7783：
> 这一讲一开始讲解了URL 、URI、超文本、http和https的概念，之后讲述了浏览器中输入url显示页面的过程原理，最后说明请求request和响应response的内容
...
> 课程内容可不可以下载成文本形式啊？
 ...
 ###### &nbsp;&nbsp;&nbsp; 官方客服回复：
> &nbsp;&nbsp;&nbsp; 不可以的呢，在拉勾学习我们可以随时互动多好。

##### **9198：
> 打卡第01讲，这一讲介绍了http的知识，了解到了在浏览网页、数据传输过程中本地与服务器之间到底是怎么传输的。2020.02.28

##### *鸟：
> 大家一起学习，共同进步！<div><br></div>
