...
##### *栋：
> 即将赶上学习进度，但发现虽然进度赶上了，内容上还是要很多基础性的要自己去消化理解。

 ###### &nbsp;&nbsp;&nbsp; 编辑回复：
> &nbsp;&nbsp;&nbsp; 夯实基础后面的更深的知识才能掌握更牢靠

##### *拓：
> lxml里面的xpath语法不香吗？崔锅锅，xpath速度比pyquery更快吧，bs4速度有点慢哦

##### **俊：
> 想问下css选择器可以选倒数的节点吗，比如倒数第二个

 ###### &nbsp;&nbsp;&nbsp; 讲师回复：
> &nbsp;&nbsp;&nbsp; 可以，如：https://www.html.cn/book/css/selectors/pseudo-classes/nth-last-child(n).htm

##### **生：
> cannot import name 'PyQuery' from partially initialized module 'pyquery' 是重命名的问题

##### *毅：
> 又看了一遍，更有印象了

##### **伟：
> 发现只要 css 学的好，这里学起来飞快的好嘛

##### **坚：
> pyquery的功能和soup.find的类似。

##### *扬：
> 十五分钟信息量蛮大的

##### *宇：
> <div>cannot import name 'pyQuery' from 'pyquery' (D:\anaconda3\lib\site-packages\pyquery\__init__.py)</div><div>这个咋解决？求解</div><div><br></div>

 ###### &nbsp;&nbsp;&nbsp; 讲师回复：
> &nbsp;&nbsp;&nbsp; 是不是写错了，应该是 PyQuery 而不是 pyQuery，注意下大小写

##### **泳：
> 好东西。

##### **2383：
> 各种教程反复看完以后，还是崔老师思路最清晰，受用受用😀
